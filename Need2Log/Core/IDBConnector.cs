...
{
    /// <summary>
    /// Enumerato utile a definire in modo fisso quale tipo di database è possibile utilizzare
    /// </summary>
    public enum AdmittedDbType
    {
        SQLite = 1
    }
    /// <summary>
    ...
    internal interface IDBConnector
    {
        ...
        /// <summary>
        /// Rappresenta un metodo utile ad ottenere dal db tutti i tipi predefiniti già esistenti
